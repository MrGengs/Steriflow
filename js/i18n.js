...
(function() {
  ...
  const DICT = {
    ...
    'common.live_label':    { id: 'Live',        en: 'Live' },

    // Notification items (generated by realtime.js)
    'notif.empty':                { id: 'Tidak ada notifikasi', en: 'No notifications' },
    'notif.steril_active.title':  { id: 'Sterilisasi Berjalan', en: 'Sterilization Running' },
    'notif.steril_active.desc':   { id: 'Sisa waktu {remain} · {mode}.', en: 'Time remaining {remain} · {mode}.' },
    'notif.voc_danger.title':     { id: 'Kontaminasi Ompreng Tinggi', en: 'High Tray Contamination' },
    'notif.voc_danger.desc':      { id: 'TVOC {value} ppb ({status}). Segera lakukan sterilisasi.', en: 'TVOC {value} ppb ({status}). Start sterilization immediately.' },
    'notif.voc_warn.title':       { id: 'TVOC Mulai Naik', en: 'TVOC Rising' },
    'notif.voc_warn.desc':        { id: 'TVOC {value} ppb ({status}). Pantau kondisi ompreng.', en: 'TVOC {value} ppb ({status}). Monitor tray condition.' },
    'notif.eco2_bad.title':       { id: 'Kualitas Gas Buruk', en: 'Poor Air Quality' },
    'notif.eco2_bad.desc':        { id: 'eCO₂ {value} ppm ({status}). Nyalakan kipas ventilasi.', en: 'eCO₂ {value} ppm ({status}). Turn on the ventilation fan.' },
    'notif.relay_active.title':   { id: 'Relay Aktif', en: 'Relay Active' },
    'notif.relay_active.desc':    { id: 'UV-C: {uv} · Fan: {fan} · Pump: {pump}.', en: 'UV-C: {uv} · Fan: {fan} · Pump: {pump}.' },
    'notif.hum_high.title':       { id: 'Kelembapan Tinggi', en: 'High Humidity' },
    'notif.hum_high.desc':        { id: 'Kelembapan {value}% — risiko pertumbuhan mikroba meningkat.', en: 'Humidity {value}% — microbial growth risk rising.' },
    'notif.temp_high.title':      { id: 'Suhu Tinggi', en: 'High Temperature' },
    'notif.temp_high.desc':       { id: 'Suhu {value} °C — lebih dari ambang 32 °C.', en: 'Temperature {value} °C — exceeds 32 °C threshold.' },
    'notif.cam_offline.title':    { id: 'Kamera Offline', en: 'Camera Offline' },
    'notif.cam_offline.desc':     { id: 'ESP32-CAM tidak terhubung. Periksa koneksi Wi-Fi perangkat.', en: 'ESP32-CAM is not connected. Check device Wi-Fi connection.' },
    'notif.hygiene.title':        { id: 'Status Kebersihan', en: 'Hygiene Status' },
    'notif.hygiene.desc_ready':   { id: 'Tingkat kebersihan: {pct}%. Ompreng siap dipakai.', en: 'Cleanliness level: {pct}%. Tray ready to use.' },
    'notif.hygiene.desc_dirty':   { id: 'Tingkat kebersihan: {pct}%. Ompreng perlu disterilkan.', en: 'Cleanliness level: {pct}%. Tray needs sterilization.' },
    'notif.steril_classify.auto': { id: 'Otomatis', en: 'Auto' },
    ...
    'landing.comp.mq.name':     { id: 'SGP30 (VOC)',    en: 'SGP30 (VOC)' },
    ...
    'dash.remaining_time':   { id: 'Sisa waktu sterilisasi', en: 'Remaining sterilization time' },
    'dash.process_running':  { id: 'Proses sedang berjalan', en: 'Process running' },
    'dash.sterilizing_pill': { id: '⟳ Sterilisasi',     en: '⟳ Sterilizing' },
    'dash.in_progress':      { id: 'Berjalan',          en: 'In Progress' },
    'dash.ready_badge':      { id: 'Siap',              en: 'Ready' },
    'dash.ready_pill':       { id: '✓ Siap',            en: '✓ Ready' },
    'dash.tray.clean':       { id: 'Bersih',            en: 'Clean' },
    'dash.tray.warn':        { id: 'Waspada',           en: 'Caution' },
    'dash.tray.dirty':       { id: 'Terkontaminasi',    en: 'Contaminated' },
    'dash.tray.clean_desc':  { id: 'Ompreng siap dipakai',       en: 'Tray ready to use' },
    'dash.tray.warn_desc':   { id: 'Segera sterilkan ompreng',   en: 'Sterilize tray soon' },
    'dash.tray.dirty_desc':  { id: 'Ompreng belum layak dipakai', en: 'Tray not fit for use' },
    ...
    'mon.label.bakteri':     { id: 'Bakteri',           en: 'Bacteria' },
    'mon.label.temp':        { id: 'Suhu',              en: 'Temperature' },
    'mon.label.hum':         { id: 'Kelembapan',        en: 'Humidity' },
    'mon.label.gas':         { id: 'Gas',               en: 'Gas' },
    'mon.label.fan':         { id: 'Kipas',             en: 'Fan' },
    'mon.status.normal':     { id: 'Normal',            en: 'Normal' },
    'mon.status.on':         { id: 'Menyala',           en: 'Running' },
    'mon.status.auto':       { id: 'Mode AUTO',         en: 'AUTO mode' },
    'mon.waiting':           { id: 'Menunggu…',         en: 'Waiting…' },
    'mon.voc.card.title':    { id: 'Bakteri (Kualitas Udara)', en: 'Bacteria (Air Quality)' },
    'mon.voc.card.desc':     { id: '20 bacaan terakhir · sensor SGP30', en: 'Last 20 readings · SGP30 sensor' },
    ...
    'mon.gas.card.title':    { id: 'Kadar Gas',         en: 'Gas Level' },
    'mon.gas.card.desc':     { id: '20 bacaan terakhir · sensor SGP30', en: 'Last 20 readings · SGP30 sensor' },
